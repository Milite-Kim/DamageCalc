//DamageCalc\js\data\equipments\sets\lightSupernaturalSet.js

const LightSupernaturalSetData = {
    "set_Id": "Light_Supernatural",
    "setName": "경량 초자연",
    "requiredPieces": 3,
    ...
    "setBonus": {
        ...
        "conditionalEffects": [
            {
                "id": "light_supernatural_defense_down",
            ...
            {
                "id": "light_supernatural_full_stack",
                "stat": "physicalDamageIncrease",
                "target": "self",
                "value": 16,
                "conditions": {
    ...
    "items": {
        "light_supernatural_stabilizer": {
            "id": "light_supernatural_stabilizer",
            "name": "경량 초자연 안정판",
            "type": "kit",
            "rarity": 5,
            "options": [
        ...
        "light_supernatural_analysis_ring": {
            "id": "light_supernatural_analysis_ring",
            "name": "경량 초자연 분석 반지",
            "type": "kit",
            "rarity": 5,
            "options": [
        ...
        "light_supernatural_gloves": {
            "id": "light_supernatural_gloves",
            "name": "경량 초자연 보호 장갑",
            "type": "gloves",
            "rarity": 5,
            "options": [
        ...
        "light_supernatural_armor": {
            "id": "light_supernatural_armor",
            "name": "경량 초자연 보호판",
            "type": "armor",
            "rarity": 5,
            "options": [
...
if (typeof window !== 'undefined') {
    window.LightSupernaturalSetData = LightSupernaturalSetData;
}
